...
namespace RewardsPlus.Infrastructure.Multitenancy.Tests;

public class ConnectionStringSecurerTests : TestBed<TestFixture>
{
    private const string Mssql = "Data Source=(localdb)\\mssqllocaldb;Initial Catalog=rewardsplusDb;MultipleActiveResultSets=True;";
